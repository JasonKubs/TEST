init python:
    ...
    event('a_visit_to_Cliohna', triggers="week_end", conditions=('cliohnaHJ',), group='ruler_event', run_count=1, priority=pr_ruler, weekend_auto=False, weekend_room="images/Backgrounds/library.jpg")
...
if alexiaWulump == True or helAlexiaWhip == True:
    ...
    menu:
        "Inform Jezera now." if jezNTR == True:
...
"Late at night, Rowan entered the library, finding Cliohna awake and deep in her studies. Some of the students were still sorting the books, but would no doubt soon retire to their rooms."

#cliohna happy

cl "Ah Rowan, how nice of you to join me."

"She welcomed him with a wry smile, tilting his head a little as she noticed the consternation on his face. "

#cliohna neutral

cl "Something on your mind? "

ro "A late night meeting, between the two of us alone? One would almost think you were trying to seduce me."

cl "Is this what you were hoping this is about?"

show rowan necklace happy at midleft with dissolve

ro "And if I was?"

#if rowan is still will alexia (TODO)
show rowan necklace neutral at midleft with dissolve
cl "Then you’d be both thoroughly disappointed to learn otherwise, and infinitely relieved to hear I’d keep that information to myself when in the company of your wife."
ro "I wasn’t aware you pull double duty as the keeper of the forbidden knowledge."
#cliohna happy
cl "A librarian knows much, and keeps much to herself. "
#cliohna neutral
cl "But no, romance was not on my mind, though some physical fun is not entirely off the table."

#else (broke up)
#cl "Then you’d be thoroughly disappointed to learn otherwise. Romance was not on my mind, though some physical fun is not entirely off the table."

#cliohna happy
"She rose up, a light smile still dancing on her lips. Somehow, that made her appear so much more dangerous than usual."

if unwantedResults == True:
    cl "As you know, I was none too happy about the results of your semen analysis. Yet after contemplating on the matter for an extended period of time, I came to a conclusion that it was not all wasted effort."
    
else:
    cl "I am still in the process of analyzing your semen, but there is one thing that has been on my mind since I took the sample."
    
if cliohnaResistance == 1:
     cl "You have shown commendable resilience against my mental spells, much greater than someone with no formal training should ever be capable of."
    
if cliohnaSubmission == 1:
    cl "Despite falling under my spell, you’ve somehow managed to retain just enough self-control to break out of it within a matter of minutes."

cl "You possess remarkable talent Rowan, and I wish to run some experiments to discover the full extent of it."

ro "And why would I agree to that?"

cl "Two reasons." 

show cliohna at cliohnaright with moveinright

"She took a step towards him, her deep cleavage swaying tantalizingly before his eyes. She leaned in, placing her hand on his chest, and lowered her voice to that of a conspiratorial whisper."

if cliohnaResistance == 1:
    cl "If you prove a… Worthy test subject, as you did before, I would not mind rewarding you for your efforts later on, as was promised. It’s not often that I meet exceptional specimens, and unlike some people in the castle I understand the value of them. :"
    
if cliohnaSubmission == 1:
    cl "First of all, I believe you will find the whole experience... Extremely exhilarating."

cl "And if that’s not enough… "

"Her smile did not drop, but the temperature in the room did. "

show rowan necklace angry at midleft with dissolve

cl "Given how valuable you’re proving to be in undermining Solansia’s oppressive regime, I am quite pleased Jezera has managed to convince you to join us, especially since at first you did not strike me as someone who could be softened with confinement and physical torture."
cl "An overly suspicious woman might even suspect foul play to be at hand. But I chose to believe your devotion to Castle Bloodmeen is honest, and as long as you are amicable to my requests, I see no reason to think otherwise. "
cl "But should that change, I will not hesitate to… Enforce your loyalty."

"Her fingers probed the amulet at his neck. A purple lightning jumped off her finger and onto the chain that held it, shocking Rowan slightly."

#cliohna annoyed
cl "Hmph, a crude solution, from a child who thinks herself an empress in the making. "

show rowan necklace happy at midleft with dissolve

ro "But I assure you Rowan, I am much, much more creative than that. "

menu:
    "Agree to her terms. Your will is stronger than her spells.":
        $ released_fix_rollback()
        ro "A carrot and a stick? I expected something more sophisticated of you, Cliohna."
        cl "If it works, then why change it?"
        "That slight grin of hers made him want to punch her, but he saw what she was capable of at the abbey. If he had to play by her terms for now, then so be it, but she would not stay on top for long."
        ro "Alright. What do I have to do?"
        jump cliohnaHypnosis
        
    "Submit to her terms. Maybe it won’t be that bad…":
        $ released_fix_rollback()
        show rowan necklace neutral at midleft with dissolve
        ro "Alright, alright… You don’t have to resort to threats. What do I have to do? "
        jump cliohnaHypnosis
        
    "No way. Call her bluff.":
        $ released_fix_rollback()
        show cliohna angry at cliohnaright with dissolve
        "He seized her by the wrist. Lighting crossed behind her eyes, and Rowan knew she was moments away from frying him on the spot."
        ro "You will do no such thing Cliohna. You said so yourself, you don’t know how strong my defenses are."
        ro "But I have a pretty good idea about them, and I assure you - I will have no trouble making myself go insane, as long as it prevents you from dominating me."
        if serveChoice == 2:
            "He already allowed his spirit to falter once. Never again."
        show cliohna neutral at cliohnaright with dissolve
        ro "I wonder what you’ll tell Jezera, when her most valuable ally ends up a drooling mess on the library floor."
        "Her eyebrows narrowed, forming a small dimple between her eyes that Rowan would normally find adorable, if the woman wasn’t threatening to mind rape him."
        cl "You’re trying to call with a pair on twos."
        ro "A pair of twos can still beat a high ace, if the conditions are right."
        "He could almost hear the crackle of her magic. All pretense of cordiality disappeared, and the tension continued to mount."
        "...In the end, she was the first to back down."
        show cliohna neutral at edgeright with moveoutright
        cl "You’re turning that bullheaded stubbornness of yours against the wrong person, but have it your way. There is no shortage of projects I must attend to. I can do without this for now."
        cl "But I expect you to be less obstinate in our future endeavours."
        if avatar.corruption > 60:
            show rowan necklace angry at midleft with dissolve
            "He met her cold gaze with an equally cold smile. Stupid bitch. He’d show her her place if she wasn’t so god damn valuable."
        else:
            "He met her cold gaze with an impassive look. It made his stomach turn to act nice after such blatant threats, but the last thing he needed was another enemy in the castle."             
        show rowan necklace neutral at midleft with dissolve
        ro "As long as you handle our research, it is my understanding the twins are more than willing to bankroll whatever private projects you pursue in your spare time."
        cl "Then we have an understanding."
        cl "Leave now. I have no further use of you today."
        $ change_relation('cliohna', -5)
        return

label cliohnaHypnosis:

cl "Not much. Just sit on this table."

hide rowan with dissolve

cl "Right here, yes. Get yourself comfortable and-"

scene hypno1 with pinkflash
#cliohna happy
show cliohna neutral behind hypno1
show rowan necklace neutral behind hypno1
pause 2

cl "{b}*Look into my eyes.*{/b}"

"The floor, the table, the room - everything suddenly just… Rolled from under him, washed away by a sudden, overwhelming wave of psychic energy. It crashed into him, sending his thoughts into disarray, breaking his defenses with laughable ease." 
"Only one thing remained - {b}*Cliohna*{/b}. A shining beacon of stability in a confusing, chaotic world that surrounded him. Her visage, her voice - it called to him, {b}*dominating*{/b} his attention." 

cl "{b}*Do you like it Rowan? I did some research, to make sure you would not fight me off again.* {/b}"
cl "{b}*Nod your head if you do.*{/b}"
cl "{b}*You know you do.* {/b}"
...
show hypno2 with dissolve
pause 2
show cliohna neutral behind hypno2

"Gritting his teeth, he forced himself to look away, and the room came back to focus again. He would not be defeated so easily!"

cl "{b}*Ah, there it is. That little bastion of resistance.*{/b}"

show hypno 1 with dissolve
pause 2
#cliohna happy
show cliohna neutral behind hypno1

"Something touched his face, spreading calm, peaceful acceptance, forcing- {b}*willing*{/b} him to look at the sorceress again."

cl "{b}*Don’t worry your little head about it Rowan. We’ll deal with it soon enough.*{/b}"

show hypno1 with pinkflash

cl "{b}*You’ll help me with it. You’ll help me bring you under.*{/b}"

show hypno1 with pinkflash

cl "{b}*All you have to do is trust me.*{/b}"

show hypno1 with pinkflash

cl "{b}*Trust me. And focus on my voice.* {/b}"

show hypno1 with pinkflash

cl "{b}*Trust me. And focus on my lips.*{/b}"

show hypno1 with pinkflash

cl "{b}*Trust me. And focus on my eyes.*{/b}"
...
label cliohnaHynosisMenu:

scene black with fade

if eventSubmission == 3:
    menu:
        "Fall deeper.":
           $ released_fix_rollback()
           jump fallDeeper
...
menu:    
    "Shake her off." if eventResistance == 3:
        $ released_fix_rollback()
        jump shakeHerOff

    "Focus on Alexia." if alexiaFocus == True:
        $ released_fix_rollback()
        $ eventResistance += 1
        scene black with fade
        "He couldn’t get the words out, but this- this witch, was just a power-tripping impostor. He had a wife. He had somebody he loved, truly loved!"
        #If Alexia and Rowan are no longer together. (TODO)
            #"… Even if they were no longer together."
            #rejoin
        show hypnobw with dissolve
        pause 2
        "He focused on that feeling, recalled how it felt to hold Alexia in his arms-"
        show cliohna neutral at center with dissolve
        cl "Using the power of love against me? Isn’t that a bit cliche, Rowan?"
        cl "{b}*Forget about her Rowan.* {/b}"
        show hypnobw with pinkflash
        cl "{b}*She is nobody.*{/b}"
        scene hypno1 with pinkflash
        pause 1
        #cliohna happy
        show cliohna neutral behind hypno1
        cl "{b}*I am all you need right now*{/b}"
        cl "{b}*Focus on me Rowan.*{/b}"
        cl "{b}*I am all you want to think about.* {/b}"
        show hypno 1 with pinkflash
        cl "{b}*Stop thinking about everything else, and fall deeper for me.*{/b}"
        $ alexiaFocus = False
        jump cliohnaHynosisMenu
      
    "Fall Deeper." if alexiaFocus == False:
        $ released_fix_rollback()
        jump fallDeeper

    "Focus on your quest." if questFocus == True:
        $ released_fix_rollback()
        $ eventResistance += 1
        scene hypno4 with fade
        pause 2
        show rowan necklace neutral behind hypno4
        show cliohna neutral behind hypno4
        ro "I…"
        "His voice cracked, but his spirit remained strong. He was Rowan Blackwell, hero of- "
        cl "Oh, please. "
        show hypno1 with pinkflash
        #clihna happy
        cl "{b}*Why struggle Rowan?*{/b}"
        cl "{b}*This is no siege of Karst. There is no demon lord to slay.*{/b}"
        cl "{b}*Don’t think about the future. Think about now.*{/b}"
        show hypno 1 with pinkflash
        cl "{b}*Think about me.*{/b}"
        cl "{b}*I am the only thing that matters.*{/b}"
        cl "{b}*Let go of your concerns. Let yourself slip away.* {/b}"
        cl "{b}*Relax.*{/b}"
        show hypno1 with pinkflash
        cl "{b}*Sink deeper.*{/b}"
        cl "{b}*You know you want to*.{/b}"
        $ questFocus = False
        jump cliohnaHynosisMenu
        
    "Fall Deeper." if questFocus == False:
        $ released_fix_rollback()
        jump fallDeeper
            
    "Focus on all you sacrificed." if sacrificeFocus == True:
        $ released_fix_rollback()
        $ eventResistance += 1
        scene black with fade
        ...
        "His village. Arthdale. The old man. Everything- "
        show cliohna neutral at center with dissolve
        cl "Yes, yes. Very tragic."
        #cliohna happy
        cl "But wouldn’t you rather {b}*forget*{/b}?"
        scene hypno1 with pinkflash
        pause 1
        #cliohna happy
        show cliohna neutral behind hypno1
        cl "{b}*Forget about all these painful memories.*{/b}"
        cl "{b}*Let yourself relax. A moment of respite.* {/b}"
        cl "{b}*You earned it.*{/b}"
        cl "{b}*You earned this.* {/b}"
        cl "{b}*Being here with me, letting all your worries slip away…*{/b}"
        show hypno1 with pinkflash
        cl "{b}*You deserve it. Embrace it.* {/b}"
        cl "{b}*Give yourself a moment of peace.* {/b}"
        cl "{b}*Rest. And fall deeper.* {/b}"
        show hypno1 with pinkflash 
        cl "{b}*Fall deeper for me Rowan.*{/b}"
        $ sacrificeFocus = False
        jump cliohnaHynosisMenu  
        
    "Fall Deeper." if sacrificeFocus == False:
        $ released_fix_rollback()
        jump fallDeeper

    "Focus on her lips." if lipsFocus == True:
        $ released_fix_rollback()
        $ eventSubmission += 1
        scene hypno1 with dissolve
        pause 1
        #cliohna happy
        show cliohna neutral behind hypno1
        show rowan necklace neutral behind hypno1
        "Full, coral lips… Moving slowly as the enchanting words slip past them…" 
        "He could watch them, and watch them… Following their slow, sensual dance…"
        cl "You like them don’t you?"
        ro "Y-yes… "
        show hypno1 with pinkflash
        cl "{b}*Then think about how they would feel on your skin.*{/b}"
        cl "{b}*Imagine them slowly kissing your body.* {/b}"
        cl "{b}*Imagine their warmth.* {/b}"
        cl "{b}*Imagine their taste.* {/b}"
        show hypno1 with pinkflash
        cl "{b}*Feel their kiss slowly bringing you under.* {/b}"
        show hypno1 with pinkflash
        cl "{b}*Under my spell, deeper and deeper.*{/b}"
        $ lipsFocus = False
        jump cliohnaHynosisMenu
        
    "Fall Deeper." if lipsFocus == False:
        $ released_fix_rollback()
        jump fallDeeper
            
    "Focus on her voice." if voiceFocus == True:
        $ released_fix_rollback()
        $ eventSubmission += 1
        scene hypno1 with dissolve
        pause 1
        #cliohna happy
        show cliohna neutral behind hypno1
        "Like a melody. Soft. Calming. Her words washed everything, leaving a behind a nice, pink haze. A fluffy cloud, he could just… Sink into…"
        cl "Good, good... "
        show hypno1 with pinkflash
        cl "{b}*Sink deeper. Let my words surround you.* {/b}"
        cl "{b}*Let them engulf you.* {/b}"
        cl "{b}*Let them fill every fibre of your being.* {/b}"
        cl "{b}*Let them caress you softly as your sink deeper, and deeper and into my trance.*{/b}"
        $ voiceFocus = False
        jump cliohnaHynosisMenu 
        
    "Fall Deeper." if voiceFocus == False:
        $ released_fix_rollback()
        jump fallDeeper

    "Focus on her eyes." if eyesFocus == True:
        $ released_fix_rollback()
        $ eventSubmission += 1
        scene hypno1 with dissolve
        pause 1
        #cliohna happy
        show cliohna neutral behind hypno1
        "Old and wise… Like a deep pool… Drawing him deep… Deep under the surface…"
        cl "That’s right… {b}*Focus on me.*{/b}"
        cl "{b}*Only on me.* {/b}"
        show hypno1 with pinkflash
        cl "{b}*Lose yourself in my eyes.* {/b}"
        cl "{b}*Let the world fade away, as you look into them.* {/b}"
        cl "{b}*Let them overwhelm you.*{/b}"
        show hypno1 with pinkflash
        cl "{b}*Let them claim you.* {/b}"
        cl "{b}*Fall into them, and sink deeper.*{/b}"
        cl "{b}*Deeper into my spell.*{/b}"
        $ eyesFocus = False
        jump cliohnaHynosisMenu 
        
    "Fall Deeper." if eyesFocus == False:
        $ released_fix_rollback()
        jump fallDeeper
...
$ cliohnaResistance += 1
$ cliohnaShookOff = True

"Honeyed words. Tantalizing lips. Mesmerizing eyes."
...
"Underhanded tricks, all of it. Parlour magic. Performed by the most powerful sorceress he ever met, but still - just tricks. "

ro "You… "

"A pained groan escaped his lips as he struggled past the thick veil of Cliohna’s enchantments. He would not submit. He refused to submit!"
"He refused to be defeated here!"

ro "Get out…"

cl "Still struggling? {b}*Oh Ro-*{/b}"

show hypno1 with sshake

ro "SHUT UP!"

"He tried to push her away. His hand trembled, refusing to move. He felt it hang on to something - the edge of the table? "

cl "Extraordinary. But ultimately- "

ro "Shutupshutupshutupshutup-"

"Don’t listen. Don’t look. Don’t let her talk. Don’t let her control anything, not even the conversation. "

cl "Isn’t it a bit too early for the madness mantra?"

"Break it. Break the spell. Break the paralysis. Do something. Anything!"

menu:
    "Hit her.":
        $ released_fix_rollback()
        show hypno1 with redflash
...
"The sorceress stepped aside, making him stumble forward. His knees gave way, and he collapsed to the floor."

#cliohna happy

cl "Astounding!"
cl "So it’s not just specific emotional anchors, but something much less tangible. The spirit itself? Some will to power? Perhaps the history of hardship helps fortify the mind?"                    
cl "That last one is almost guaranteed in your case, but how come you strive under the pressure, when others break… "

show rowan necklace shock at center with dissolve

"Still dazed, he managed to get up. Cliohna was already at her table, scribbling notes like crazy."

show rowan necklace angry at center with dissolve

"She made him go through hell, and didn’t even bother to acknowledge it. A bitter taste filled his mouth, and Rowan realized he bit his tongue falling. He wiped the blood off his lips, and turned his hateful gaze towards the sorceress."

ro "If that’s everything, I’ll be going now. "

cl "Hm? Oh yes, yes, that will be all."
cl "I’ll send for you once I refine my method. In the meantime, do get some rest. I’d hate to succeed due to something so basic as sleep deprivation. "

ro "Your concern warms my heart. "

"She didn’t even notice the growl in his voice. But no matter. He’ll play along… "
...
scene hypno5 with dissolve
#cliohna happy
show cliohna neutral behind hypno5
show rowan necklace neutral behind hypno5
pause 1

"Her voice continued to sing to him. Her lips, her eyes, they called to him. Everything else melted away, leaving only {b}*Cliohna*{/b}."

cl "{b}*That’s right Rowan… Fall deep, deep into the comforting darkness.* {/b}"

"Something trailed down his chest, sending fiery warmth across his body. Something inside of him panicked at how easily it spread, dreaded how quickly it burst forth, how it threatened to consume him." 
"He should be fighting it. He should be screaming and kicking, forcing this foreign influence away. He should be. He should be. He should be- "

cl "You still struggle! Despite all the work I put into this, I don’t think it could hold you for longer than a few minutes! Absolutely astounding!  "

"The searing fire reached his stomach, and continued to trail down. He knew where it was going. He wanted it to reach there - but he also feared what would happen if it did." 
"He feared losing himself in that fire, losing himself in the touch of the woman before him. "

cl "But I will not hold this against you… Even if your submission is temporary at best, I still consider the experiment a resounding success. "
cl "And I have you to thank… You did well, listening and watching..."
cl "So let me reward you for your efforts, hero. "

"A breeze of cool air, as his cock sprung free. Then - fire again. Encompassing lust, rocking him to the core."

ro "A-ah! "

cl "Sh-sh… "

"A soft kiss silenced his moan. Soft mounds pressed against his chest, fueling the fire that threatened to engulf him."

cl "Here… For being such a good test subject… "

"Something wet touched the tip of his shaft, spreading soothing calm across his sensitive skin. The feeling spread further down his cock, drawing him in, deeper into Cliohna. Deeper into her eyes, deeper into her body. "

cl "Relax now… "

ro "A-ah…"

"Her visage started to bob gently before his eyes, and with it, the warm, tight embrace around his cock started to move up and down his shaft as well." 
"Another moan escaped his lips, drowning out the quiet, screeching voice in the back of his skull. “Stop it!”? Why should he? How could he?"

cl "No need to worry… Just enjoy the ride… I’ll let come out of this soon enough… "

"Her melodic voice calmed the unease in his mind, while her moist pussy quenched the fire of his loins. He felt her grab him by the hands, felt her put them on her hips. They raised and fell rhythmically, bringing unimaginable pleasure."

cl "I want you to remember how good it felt…"
cl "How good it was to lower your defenses and let me take control…"
cl "And maybe next time… Don’t struggle so much? "

"Her breath tickled his ear, and she followed with a trail of slow, sensual kisses. On his cheek. On his eyes. On his nose. On his lips." 
"All while her pussy continued to squeeze him, a nice, wet cave of wonder his cock never wished to leave." 

cl "Remember how good my pussy felt… Engrave it in your memory… "
cl "And now… Cum for me. "
cl "Cum for me."

show hypno5 with pinkflash

cl "{b}*Cum for me.*{/b}"

"What little resistance he still managed to hold on to, evaporated like a drop of water in the middle of a desert. He threw his head back, and spurted straight into her, blessing her with his seed."
"Cliohna let out a delighted chuckle. She wouldn’t forget the expression on Rowan’s face for a long time… Such dazed contentment, such puppy-like obedience." 

cl "Mmmm… Excellent. "
cl "You did well Rowan. You can rest now. "
cl "{b}*Rest. Rest, and dream of this moment.*{/b}"

scene hypnodarkbg with dissolve
show rowan necklace neutral behind cliohnadarkbg

"Exhaustion took his limbs, his world growing darker. Finally, he could surrender to these sweet dreams of submission- "

ro "(No! Get a hold of yourself, damn it!)"

"Something stirred inside of him. A still smoldering ember of defiance."
"He couldn’t… He couldn’t let it end like this!" 
"He needed to do something, anything!" 

scene bg12 with fade

"Through what could only be described as titanic effort, he pushed himself past the veil of exhaustion and magical lethargy, fought off the enchanted malaise. Grunting from the effort, he somehow managed to roll over, away from Cliohna."

show rowan necklace concerned at center with dissolve

"His arms could as well be made of lead, and his knees of cotton, but he somehow managed to push himself off the table. He got back on his feet, wobbly as they were."

cl "Oh?"

show cliohna neutral at cliohnaright with dissolve

"He saw the sorceress watching him from the sidelines, furiously noting something down in her notebook. He tried to snarl, but settled for an annoyed whizz."

cl "Extraordinary. Absolutely extraordinary!  And here I thought the mental exertion would be too much for you to stay awake. "

if alexiaSeparateRoom == False:
    ro "I have a… Wife… Waiting for me."
    if NTR:
        cl "Wouldn’t want someone else taking your place, I take it."
    else:
        cl "And she’s been waiting for you all week. I’ll admit, it wouldn’t be nice to leave her alone."

elif rowan_shares_room_with_helayna:
    ro "Helayna… Is waiting for me. "
    cl "Quite considerate of you. I was surprised I didn’t see her in your mind."
    
else:
    ro "I prefer… My own bed… To cold wood."
    cl "Ah, don’t we all! "
    
"He gritted his teeth. He failed. Failed to lock her out. Yet the worst part was, that somehow…"
"Somehow it didn’t bother him as much as it should. There was this nice, warm feeling all over his body, a sleepy satisfaction, of sorts."

ro "… You got what you wanted, I take it? "

cl "Hm? Oh, yes! In fact, I found the whole experience very illuminating. I shall study the results, then adjust my approach for our next session."

ro "… “Next session”? "

"Her lips curled into a small, satisfied smile. He hated how he now couldn’t take his eyes off them."

cl "Why of course! Further testing is necessary to verify everything I learned today!"
cl "But you don’t mind, do you Rowan? "
cl "No, of course you don’t. "
cl "You’ll come back to me. "

ro "I-"

show rowan necklace shock at center with dissolve

cl "{b}You’ll come back to me.*{/b}"
...
cl "Excellent."
cl "You can go now. Rest well, Rowan Blackwell."

#Add temporary status. “Cliohna’s Trance: +1 Diplomacy, -1 Agility.”, for 4 weeks. (TODO)
return
