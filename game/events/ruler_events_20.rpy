init python:
    ...
    #Wall Inspection
    event('wall_inspection', triggers="week_end", conditions=('week > 5',), group='ruler_event', run_count=1, priority=pr_ruler, weekend_auto=False, weekend_room="bg20")
    #Five Years Alone
    event('five_years_alone', triggers="week_end", conditions=('week >= 30',), depends=('champion_statue_sculpting',), group='ruler_event', run_count=1, priority=pr_ruler, weekend_auto=False, weekend_room="bg20")
    #what is precious to me?
    event('what_is_precious_to_me', triggers="week_end", conditions=('week >= 40',), depends=('five_years_alone',), group='ruler_event', run_count=1, priority=pr_ruler, weekend_auto=False, weekend_room="bg20")
...
scene cg467 with fade
show skordred neutral behind cg467
show rowan necklace neutral behind cg467
pause 3
...
scene cavesexanimation with fade
show skordred neutral behind cavesexanimation
show rowan necklace naked behind cavesexanimation
...
#cumshot cg
show cg468 with dissolve
pause 0.5
scene cg469 with flash
pause 0.5
show cg470 with dissolve
show skordred neutral behind cg470
show rowan necklace naked behind cg470
