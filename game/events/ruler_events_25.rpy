init python:
    event('more_futa_fun', triggers="week_end", conditions=('week >=4', 'futaIntrigued == True',), depends=('alexia_become_like_xzaratl',), group='ruler_event', run_count=1, priority=pr_ruler, weekend_auto=False, weekend_room="bg23")
