init python:
    ...
    event('greyhide_s_table_manners', triggers="week_end", conditions=('week >=4', 'drinking_buddies_introduce_alexia',), depends=('drinking_buddies',), group='ruler_event', run_count=1, priority=pr_ruler, weekend_auto=False, weekend_room="bg22")
...
menu:
    "Fuck him.":
        ...
        #CG1 - Draith assfuck from behind
        scene black with fade
        #draith aroused
