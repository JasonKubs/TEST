init python:
    ...
    event('greyhide_shares_his_people_s_liquor', triggers="week_end", conditions=('week >=4', 'drinking_buddies_suggestion == "men"'), group='ruler_event', run_count=1, priority=pr_ruler, weekend_auto=False, weekend_room="bg22")
    #Jezera is stressed
...
show greyhide neutral at cliohnaright behind cg443
show rowan necklace happy at midleft behind cg443
pause 3
