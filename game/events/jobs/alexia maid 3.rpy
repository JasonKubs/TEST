...
if alexiaSeparateRoom == True:
    scene cg365 with fade
    pause 2
    scene cg366 with dissolve
    pause 3
    show alexia maid shock behind cg366

else:
    scene cg367 with fade
    pause 2
    scene cg368 with dissolve
    pause 3
    show alexia maid shock behind cg368
