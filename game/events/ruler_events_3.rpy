init python:
    ...
    event('xzaratl_s_advances', triggers="week_end", conditions=("castle.buildings['sanctum'].lvl >= 1", 'week >=4'), group='ruler_event', active=False, run_count=1,
        priority='pr_ruler_high if friendly_to_xzaratl else pr_ruler', weekend_auto=True, weekend_room="bg23")
    ...
    event('goblin_family_dinner', triggers="week_end", conditions=('week >= 4',), group='ruler_event', depends=('learning_about_goblins',), run_count=1, priority=pr_ruler, weekend_auto=False, weekend_room="bg19")
    # Problem squad
