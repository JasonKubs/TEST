init python:
    ...
    event('liurial_wants_a_protector', triggers="week_end", conditions=('week == 24',), group='ruler_event', run_count=1, priority=pr_ruler_high)
...
scene cg363 with fade
pause 2
scene cg364 with dissolve
pause 3
...
menu .liurial_first_encounter_kiss:
    "Tease her." if not event_tmp['teased']:
        $ released_fix_rollback()
        show rowan necklace happy behind cg364
        show liurial naked happy behind cg364
    ...
    "End this.":
        $ released_fix_rollback()
        show rowan necklace neutral behind cg364
        show liurial naked sad behind cg364
