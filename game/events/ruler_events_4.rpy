init python:
    ...
    #Req: After week 8
    event('champion_statue_sculpting', triggers="week_end", conditions=('week > 15',), depends=('wall_inspection',), group='ruler_event', run_count=1, priority=pr_ruler, weekend_auto=False, weekend_room="bg20")
    #Cliohna's hero studies
    #Req: After week 6, high priority after week 14
    event('cliohna_s_hero_studies', triggers="week_end", conditions=('week > 5',), group='ruler_event', run_count=1, priority=pr_ruler, weekend_auto=False, weekend_room="images/Backgrounds/library.jpg")
...
#rowan wry
ro "(She’s not someone used to rejection… But as long as I stay sharp, she won’t be able to do as she pleases.)"

menu:
    "Agree to the handjob.":
        $ cliohnaHJ = True
        $ released_fix_rollback()
        jump .cliohnaHJ
...
show rowan necklace aroused behind cg186
pause 3
...
"Suddenly it felt like a mountain was pushing him down. For a moment the man was able to hold out, but the sensation of soft cool fingers gliding over his cock with increasing speed soon knocked a hole in his defences and swept him under the wave of magic."
...
menu:
    "Fight back with all your might!":
        $ released_fix_rollback()
        $ cliohnaResistance += 1
        "But it was not like he ever got the chance to practice that stuff. All of his knowledge, he gained in the heat of battle, finding the will and the means to resist when death looked him in the eyes."  
        "What was a handjob in comparison?"       
        cl "Ah?"
        "Cliohna’s eyebrow rose in an expression of delighted surprise, as she felt Rowan's fingers lightly wrap around her wrists. He tried for an iron grip, but with her mental assault still unrelenting, it was the best he could manage. "
        cl "How... Ah. Biting your tongue, Rowan? I see you are no stranger to the classics." 
        "He struggled to offer a clever response, but the pressure didn’t weaken one bit, threatening to break his mind in half the moment he let his self-control lapse." 
        "And her fingers, making their way up and down his shaft, sending pleasant, numbing shocks up his body, weren’t helping."
        cl "Fascinating. The stronger I push you, the harder your walls become."
        ro "Among… Other… Things…? "
        cl "And you are somehow able to retain enough wit, as low level as it is, to hold a conversation! You’re quite the specimen!"
        cl "Makes me wonder how much further I can take this."
        ro "For science?"
        "His mouth twitched. At least that's what he thought happened. All that teeth grinding made his face hurt. Was he still smiling? He might have. It was impossible to be certain of anything at the moment."  
        "But despite that, he had just enough fight in him to narrow his eyes, and issue the sorceress a silent challenge."  
        "“Try me.”"
        "In response, Cliohna flashed him a quick smile, and the pressure on his mind finally started to subside."
        cl "Quite stubborn, aren’t you? I do not know if I should envy or pity your wife."
        "She poked his shaft playfully, the resumed the dance of her fingers. Her touch grew less mechanical, taking on a caring, almost sensual vibe."
        cl "Usually I would not mind playing with you some more, turning this defiant look into one of pure adoration…"
        cl "But your sudden resistance has only inflamed my desire to uncover whatever secrets your cum might hold. I propose a truce."
        cl "Stop fighting back and share your cum with me, and in return, maybe later on, if you're strong enough, I’ll give you a shot at turning the tables on me?"
        ro "Maybe? That’s all I get?"
        cl "Aren’t you the hero of men, Rowan Blackwell? Isn’t a sliver of a chance all you need to succeed?"
        "Part of him wanted to sneer at her proposal, discard it without a second thought, deny her the damn satisfaction." 
        "But he still felt this small, continuous pressure in the back of his mind. A gentle reminder that while Cliohna allowed him the peace of mind for now, she could resume her assault at any moment." 
        ro "… Maybe it is."
        cl "Paramount decision making Rowan! I can see why both Jezera and the royalty of Rosaria chose to put their fate in your hands."
        "He gritted his teeth. Her caresses increasing in intensity, her fingers still only gently brushing against his skins, but her magic-" 
        ro "A-ah!"
        "Her magic kept sending small, pleasant shocks up his shaft. He wanted to resist her further, but he had to concede he was at his limit." 
        "With a wave of her free hand, a small flask sitting on the nearby table floated over to them, and Cliohna got it ready to receive his seed."
        scene cg186 with sshake
        show cg186 with sshake
        show cg187 with flash
        "He reached his peak and leaned backwards, as ropes of cum sprayed out into the waiting flask. The sorceress flashed him a satisfied grin, not at all dismayed by his earlier resistance."
        scene bg12 with fade
        show rowan necklace angry at midleft with dissolve
        #cliohna smile
        show cliohna neutral at cliohnaright with dissolve
        ro "How about you start with a taste test?"
        cl "Now now Rowan, this was all in the name of science. Please do not ascribe to it any sexual undertones. "
        cl "You can leave now, I shall contact you once I have the results ready."
        ro "... Right. Glad to be of assistance. "
        return
        
        
    "Cliohna proves too powerful to resist.":
        $ released_fix_rollback()
        $ cliohnaSubmission += 1   
        ...
        "Rowan continued to eat the woman out, but with each passing moment he felt his faculties grow more and more under his own control again."
        "Cliohna was both powerful and skilled, but she made the mistake of underestimating him. Indulging herself in his caress, her focus wavered, and her spell loss some of its intensity. If he could keep it up… "
        cl "Ooooh, yes Rowan, yes! Just like that!"
        "The normally calm and disdainful witch was now breathing heavily, shuddering occasionally as his tongue brought her closer and closer to orgasm."
        cl "Deeper, deeper!"
        "A final tremor rushed through her body and the witch let out a soft moan. Cliohna's passage rippled and squeezed in time with her peak, and the spell around his mind shattered."
        cl "Good, stop.  You may- oh?"
        scene bg12 with fade
        show rowan necklace neutral at midleft with dissolve
        show cliohna neutral at cliohnaright with dissolve
        "Rowan emerged from under the table as well, straightening up and looking at the woman he'd just eaten out.  The two studied one another for a moment before Cliohna broke the silence."
