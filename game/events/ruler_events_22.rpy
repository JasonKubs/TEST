...
if all_actors['alexia'].corruption > 30:
    if rowanLiurialLie == True:
        ...
        #elfsome cg1
        scene cg413 with fade
        show rowan necklace naked aroused behind cg413
        show liurial aroused behind cg413
        show alexia necklace aroused behind cg413
        pause 3
...
#elfsome cg3
scene cg374 with fade
show liurial naked aroused behind cg374
show alexia necklace naked aroused behind cg374
...
show cg375 with dissolve
pause 0.5
show cg376 with dissolve
pause 0.5
show cg377 with dissolve
pause 0.5
show cg378 with dissolve
pause 0.5
...
"From Rowan’s vantage point, he couldn’t see Alexia’s face. He could only imagine the drip of his cum down Alexia’s tongue back into Liurial’s pussy. But, he didn’t have to imagine Liurial’s reaction. The way she rolled her head back and let out a long groan was so sexy."
...
show cg379 with flash
pause 1
show cg380 with dissolve
pause 3
