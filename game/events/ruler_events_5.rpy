init python:
    ...
    event('drinking_buddies', triggers="week_end", conditions=('week >=4', "castle.buildings['tavern'].lvl >= 1"), active=False,
        group='ruler_event', run_count=1, priority=pr_ruler, weekend_auto=False, weekend_room="bg21")
...
"This was evidently the last straw for the demoness, as she suddenly stood up and tossed the lead of Rowan's leash aside. Ribbons of magic blazed to life around her, knocking the crystal furniture aside."
...
je "I'll show you what happens to those who deny me."
...
je "If you won't serve me, then I'll find another who will."
