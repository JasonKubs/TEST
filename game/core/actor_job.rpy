init python:
    ...
    all_actor_jobs = {
        'maid': {'name': 'Maid',
            'skill': 'domestics', 'boss': 'Jezera', 'effect': 'Reduced maintenance cost of surface buildings', 'description': 'Domestic work: Help the other castle staff who directly answer to Jezera.', 'image_suffix': 'Maid'},
        'research_assistant': {'name': 'Research Assistant',
            'skill': 'academics', 'boss': 'Cliohna', 'effect': 'Extra research points', 'description': 'Research Assistant: Help Cliohna\'s research staff in the library.', 'image_suffix': 'Library'},
        'barmaid': {'name': 'Barmaid',
            'skill': 'domestics', 'boss': 'Indarah', 'effect': 'Boosted tavern income and some extra weekly money', 'description': 'Barmaid: Work as a barmaid under Indarah at the tavern in Rakshan Wastes.', 'image_suffix': 'Barmaid'},
        'breeding': {'name': 'Breeding',
            'skill': 'zoology', 'boss': 'Draith', 'effect': 'Capacity, reduced maintenance of monsters', 'description': 'Caretaker: Work as a cleaner and handler in the Breeding Pits.', 'image_suffix': 'Breeding'},
        'forge': {'name': 'Forge hand',
            'skill': 'crafting', 'boss': 'Greyhide', 'effect': 'Reduced armour craft cost / resource usage / convert more iron into equipment', 'description': 'Smithing: Assist Greyhide with weapon and armor smithing.', 'image_suffix': 'Forge'},
    }
