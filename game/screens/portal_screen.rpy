...
init python:
    ...
    portal_region_buttons = {
        'rosaria': [
            ['central_rosaria', (135, 240), 'gui/portal/Button_CentralRosaria_Neutral.png', 'gui/portal/Button_CentralRosaria_Pressed.png', JumpToPortal('rosaria_map', 'Central Rosaria')],
