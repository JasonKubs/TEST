...
default NTR = False
default jezNTR = False
default andrasNTR = False
...
default helBedslavePath2 = False
...
default unwantedResults = False

default cliohnaResistance = 0
default cliohnaSubmission = 0
default cliohnaShookOff = False
default cliohnaDeeper = False
default hypnosis2SubEnding =  False
default Hypnosis2DomEnding = False
default rowanCliohnaFurious = False
default rowanCliohnaHappy = False

default nasimTF = False
...
default claNasQuarrel = False
default claNasBlackmail = False
default CounterfeitGoblinDealtWith = False
default counterfeitUndiscovered = False
default alexiaLiurialFriendly = False
default shayaPrivateShow = False
default heartsongDream = False
default heartsongLove = False
default HSDreamSex = False
default differentAlphabetOrdersSeen = False
default cliohnaDominationPromise = False
default cliohnasChampion = False
default HelOrgasmTraining = False

default raeveKeepCapture = "none"
...
default alexiaSecondsSex = False
default alexiaJezObedient = False
default alexiaAndrasObedient = False
default jezCorVisits = 0
default midCorHappened = False
default midCorFlee = False
default maryNakedSeen = False
default alGreyhideForgeSex = False
default POTTaken = False
default POTscene = "None"
...
default rastCopperAccess = False
default rastBarracksAccess = False
...
default werdensPitch = False
default rastActThree = False
default rastActFour = False
default firstLodgeVisitPostBattle = True
default delaneLodgeSex = False
default ameraineRescue = False
default werdenTalkFailed = False
default copperJacquesMet = False
default lodgeFirstMeetings = False
default rastForkingPaths = False
default rastAlly = "none"
default jacquesAbbeyPlan = False
default werdenAbbeyPlan = False
default patriciaAbbeyPlan = False
default rastAllyChosen = None
default rastAllyChose = False
default verdoinFirstVisit = False
default verdoinCounter = 0
default rastCrime = 0
default rastPerformanceReview = False
default werdenCoup = False
default werdenCoupTalk = False
default jacquesCoup = False
default jacquesCoupTalk = False
default alainInspired = 0
default alainHardened = 0
default eleaLeft = False
default delaneAlly = False
default act4BaronMeet = False
default slumsIntroSeen = False
default slumsEvent1Seen = False
default maudClues = 0
default knowCalhoun = False
default slumsEvent2Seen = False
default knowHandsign = False
default slumsEvent3Seen = False
default doctorThreatened = False
default maudLook = False
default beggarLowCorEnd = False
default beggarHighCorEnd = False
default slumsEvent4Seen = False
default slumWhoreInformation = False
default ShariNoSexFailed = False
default alainMet = False
default julietSex = False
default sternCouncilSeen = False
default clubbingSealSeen = False
default julietSexAvailable = False
default delMeet2Seen = False

#######################################################################################
#jobs

default garInfo = 0
default garSpy = False
