...
init python:
    ...
    'cg61', 'cg54', 'cg55', 'cg119', 'cg120', 'cg129', 'cg130', 'cg62', 'cg63', 'cg466', 'cg67', 'cg231', 'cg459', 'cg460', 'cg461', 'cg462', 'cg463', 'cg464', 'cg465', 'cg188', 'cg124', 'cg68', 'cg311', 'cg94', 'cg95', 'cg127', 'cg128',  'cg69', 'cg70', 'cg71', 'cg89', 'cg90', 'cg91',  'cg195', 'cg196', 'cg197', 'cg198', 'cg199',
    ...
    'cg501', 'cg502', 'cg503', 'cg504', 'cg505', 'cg512', 'cg513', 'cg514', 'cg515', 'cg516', 'cg517', 'cg518', 'cg519', 'cg520', 'cg521', 'cg526', 'cg527', 'cg528', 'cg529', 'cg530', 'cg535', 'cg536', 'cg537', 'cg542', 'cg543']
    ...
    artists_info = {
    'cg1': ('День радости 1', 'momdadno', 'http://momdadno.tumblr.com/'),
...
screen cg_gallery(g_cg, cg_seq):
    ...
    vbox:
        ...
        hbox at nav_eff:
            ...
            spacing 10
            if cg_page > 0:
                textbutton _("Предыдущая") action [If(cg_page > 0, true=SetScreenVariable('cg_page', cg_page - 1), false=NullAction()), With(dissolve)] xalign 0.0
            if len(cg_seq) > gal_cells:
                textbutton _("Следующая") action (SetScreenVariable('cg_page', next_cg_page), With(dissolve)) xalign 1.0
    use progress
...
screen music_room:
    ...
    vbox:
        ...
        hbox:
            ...
            vbox:
                style_group "navi"
                textbutton "Семена хаоса" action [SetVariable("track_length", "1.19"), SetVariable("track_playing", "Track 1"), mr.Play("music/title screen loop.ogg")] at nav_eff
                textbutton "Бриз деревни" action [SetVariable("track_length", "1.41"), SetVariable("track_playing", "Track 2"), mr.Play("music/village loop.ogg")] at nav_eff
                textbutton "Женщина в красном" action [SetVariable("track_length", "2.00"), SetVariable("track_playing", "Track 3"), mr.Play("music/Jezera 1 loop.ogg")] at nav_eff
                textbutton "Лесная Засада" action [SetVariable("track_length", "1.23"), SetVariable("track_playing", "Track 4"), mr.Play("music/Orc Ambush loop.ogg")] at nav_eff
            null width 20
            vbox:
                style_group "navi"
                textbutton "Правда Раскрыта" action [SetVariable("track_length", "1.51"), SetVariable("track_playing", "Track 5"), mr.Play("music/Jezera 2 loop.ogg")] at nav_eff
                textbutton "Дым и пламя" action [SetVariable("track_length", "1.59"), SetVariable("track_playing", "Track 6"), mr.Play("music/burning village loop.ogg")] at nav_eff
                textbutton "Ветер Отвечает" action [SetVariable("track_length", "1.59"), SetVariable("track_playing", "Track 7"), mr.Play("music/destroyed village loop.ogg")] at nav_eff
                textbutton "Перед воротами" action [SetVariable("track_length", "1.43"), SetVariable("track_playing", "Track 8"), mr.Play("music/before the gates loop.ogg")] at nav_eff
            null width 20
            vbox:
                style_group "navi"
...
screen scene_replay():
    ...
    vbox:
        ...
        hbox at nav_eff:
            ...
            spacing 10
            if rp_page > 0:
                textbutton _("Предыдущая") action [If(rp_page > 0, true=SetScreenVariable('rp_page', rp_page - 1), false=NullAction()), With(dissolve)] xalign 0.0
            if len(replay_scenes) > gal_cells:
                textbutton _("Следующая") action (SetScreenVariable('rp_page', next_rp_page), With(dissolve)) xalign 1.0
